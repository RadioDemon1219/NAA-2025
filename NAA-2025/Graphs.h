...
#define GRAPH_STRING_LITERAL 3,\
	...
	FST::NODE(88, \
			...
			FST::RELATION('!', 1), FST::RELATION('?', 1), FST::RELATION('#', 1), FST::RELATION('&', 1),\
			FST::RELATION('>', 1), FST::RELATION('<', 1), FST::RELATION('[', 1), FST::RELATION(']', 1),\
			FST::RELATION('\"', 2), FST::RELATION('\xFF', 1)),\
	FST::NODE()
...
#define GRAPH_CHAR_LITERAL 4, \
    ...
    FST::NODE(88, \
        ...
        FST::RELATION('!', 2), FST::RELATION('?', 2), FST::RELATION('#', 2), FST::RELATION('&', 2), \
        FST::RELATION('>', 2), FST::RELATION('<', 2), FST::RELATION('[', 2), FST::RELATION(']', 2), \
        FST::RELATION('\"', 2), FST::RELATION('\'', 2), FST::RELATION('\xFF', 2)), \
...
// простые графы для операторов ^ и #
#define GRAPH_POWER 1, FST::NODE(1, FST::RELATION('^', 1)), FST::NODE()
#define GRAPH_TRANSFORM 1, FST::NODE(1, FST::RELATION('#', 1)), FST::NODE()

// алиас для 'int' ключевого слова (если где-то используется GRAPH_INT)
